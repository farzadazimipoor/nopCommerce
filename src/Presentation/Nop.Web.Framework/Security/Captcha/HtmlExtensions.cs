...
namespace Nop.Web.Framework.Security.Captcha
{
    ...
    public static class HtmlExtensions
    {
        ...
        public static GRecaptchaControl GenerateCaptcha(this IHtmlHelper helper)
        {
            ...
            if (captchaSettings.IsAllowedAutomaticallyChooseLanguage)
            {
                ...
                lang = supportedLanguageCodes.Contains(culture) ? culture :
                    supportedLanguageCodes.Contains(seoCode) ? seoCode : lang;
            }
